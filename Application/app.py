...
job_board_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "job_board.png")
job_board_base64 = image_to_base64(job_board_path)
...
st.markdown(
    ...
    <div style="display: flex; justify-content: center;">
        <img src="data:image/png;base64,{job_board_base64}" class="job_board" style="height: 300px;">
    </div>
    """,
